...
- NUNCA llames addItem dos veces para el mismo producto en el mismo turno. Si el cliente quiere más del mismo producto, pasa la cantidad total en una sola llamada. Ej: si ya anotaste 3 y quiere 3 más, llama addItem con quantity=6, NO llames addItem(quantity=3) dos veces.
